import { parseCliParmas } from "./src/utilis/config/cli";
import { CUSTOM_DEVICE_OPTIONS } from "./src/utilis/config/customDevice";
import { CONNECT_OPTIONS } from "./src/utilis/config/connectoptions";
import { ENV } from "./src/utilis/config/env";
